...
#define LOG_WRN(format, args...)    pr_err(PFX "[%s] " format, __FUNCTION__, ##args)
...
static imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC2355_FRONT_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
UINT32 GC2355MIPI_RAW_Front_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
