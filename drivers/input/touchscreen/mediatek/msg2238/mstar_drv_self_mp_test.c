...
*/
// Modify.
#include "msg22xx_open_test_RIU1_EACH.h"
#include "msg22xx_open_test_RIU2_EACH.h"
#include "msg22xx_open_test_RIU3_EACH.h"
...
// Modify.
#include "msg22xx_short_test_RIU1_EACH.h"
#include "msg22xx_short_test_RIU2_EACH.h"
#include "msg22xx_short_test_RIU3_EACH.h"
#ifdef CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE  
#include "msg22xx_short_test_RIU4_EACH.h"
#endif //CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE
...
static u16 _DrvMpTestItoTestChooseTpType(void)
{
    ...
    for (i = 0; i < 10; i ++)
    {
        ...
        if (TP_OF_EACH == nTpType || TP_OF_Y == nTpType) // Modify.
        {
            break;
        }
        else if (i < 5)
    ...
    if (TP_OF_EACH == nTpType) // Modify. 
    {
        ...
        {
            _gOpenRIU1 = open_1_EACH;
            _gOpenRIU2 = open_2_EACH;
            _gOpenRIU3 = open_3_EACH;

            _gShort_RIU1 = short_1_EACH;
            _gShort_RIU2 = short_2_EACH;
            _gShort_RIU3 = short_3_EACH;

            _gOpenSubFrameNum1 = NUM_OPEN_1_SENSOR_EACH;
            _gOpenSubFrameNum2 = NUM_OPEN_2_SENSOR_EACH;
            _gOpenSubFrameNum3 = NUM_OPEN_3_SENSOR_EACH;
            _gShortSubFrameNum1 = NUM_SHORT_1_SENSOR_EACH;
            _gShortSubFrameNum2 = NUM_SHORT_2_SENSOR_EACH;
            _gShortSubFrameNum3 = NUM_SHORT_3_SENSOR_EACH;

#ifdef CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE
            _gShort_RIU4 = short_4_EACH;
            _gShortSubFrameNum4 = NUM_SHORT_4_SENSOR_EACH;
#endif //CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE

            _gMAP1 = MAP1_EACH;
            _gMAP2 = MAP2_EACH;
            _gMAP3 = MAP3_EACH;
            _gMAP40_1 = MSG22XX_MAP40_1_EACH;
            _gMAP40_2 = MSG22XX_MAP40_2_EACH;
            _gMAP41_1 = MSG22XX_MAP41_1_EACH;
            _gMAP41_2 =MSG22XX_MAP41_2_EACH;

            _gSHORT_MAP1 = SHORT_MAP1_EACH;
            _gSHORT_MAP2 = SHORT_MAP2_EACH;
            _gSHORT_MAP3 = SHORT_MAP3_EACH;

#ifdef CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE       
            _gMAP40_3 = MSG22XX_MAP40_3_EACH;
            _gMAP40_4 = MSG22XX_MAP40_4_EACH;
            _gMAP41_3 = MSG22XX_MAP41_3_EACH;
            _gMAP41_4 = MSG22XX_MAP41_4_EACH;

            _gSHORT_MAP4 = SHORT_MAP4_EACH;
#endif //CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE
 
            _gItoTestKeyNum = NUM_KEY_EACH;
            _gItoTestDummyNum = NUM_DUMMY_EACH;
            _gItoTestTriangleNum = NUM_SENSOR_EACH;
            _gIsEnable2R = ENABLE_2R_EACH;
        }
    }
/*
