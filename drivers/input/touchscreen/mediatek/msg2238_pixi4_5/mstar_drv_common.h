...
//#define CONFIG_TOUCHSCREEN_MTK_HQ_GESTURE

// ------------------- #ifdef CONFIG_ENABLE_GESTURE_WAKEUP ------------------- //
#ifdef CONFIG_ENABLE_GESTURE_WAKEUP
#ifdef CONFIG_TOUCHSCREEN_MTK_HQ_GESTURE
//#define MSG_GESTURE_PROC_MODE
 #define MSG_GESTURE_SYSFS_MODE

 #define KEY_GESTURE 	250
#define KEY_GESTURE_RIGHT   0x21b
#define KEY_GESTURE_LEFT   0x21c
#define KEY_GESTURE_UP   0x21d
#define KEY_GESTURE_DOWN   0x21e
#define KEY_GESTURE_U   0x21f
#define KEY_GESTURE_O   0x220
#define KEY_GESTURE_E   0x221
#define KEY_GESTURE_M   0x222
#define KEY_GESTURE_W   0x223
#define KEY_GESTURE_L   0x224
#define KEY_GESTURE_C   0x225
#define KEY_GESTURE_Z   0x226
#define KEY_GESTURE_S   0x227
#define KEY_GESTURE_V   0x228
#endif
...
#ifdef CONFIG_TOUCHSCREEN_MTK_HQ_GESTURE
#define GESTURE_WAKEUP_PACKET_LENGTH    (124)//(6)

#define MSG_GESTRUE_POINTS 				255
extern u8 msg_original_coordinate[200];
#else
