...
#include "open_test_RIU1_JD.h"
#include "open_test_RIU2_JD.h"
#include "open_test_RIU3_JD.h"
#include "short_test_RIU1_JD.h"
#include "short_test_RIU2_JD.h"
#include "short_test_RIU3_JD.h"
#include "short_test_RIU4_JD.h"
...
// Modify.
#define TP_OF_X    (16) //HLT
#define TP_OF_Y    (12) //JD
...
/*=============================================================*/
#define ITO_JUST_FOR_WT

#ifdef ITO_JUST_FOR_WT
u8 error_flag=1;
#endif
...
u16 _DrvMpTestItoTestGetTpType(void)
{
    ...
    if (g_ChipType == CHIP_TYPE_MSG21XXA)
    {
		...
		printk("jiayu.ding g_ChipType = %d\n",g_ChipType);
    }
...
/*            _gOpen1 = MSG21XXA_open_1_X;
        ...
        {
            _gOpenRIU1 = open_1_HLT;
            _gOpenRIU2 = open_2_HLT;
            _gOpenRIU3 = open_3_HLT;

            _gShort_RIU1 = short_1_HLT;
            _gShort_RIU2 = short_2_HLT;
            _gShort_RIU3 = short_3_HLT;

            _gOpenSubFrameNum1 = NUM_OPEN_1_SENSOR_HLT;
            _gOpenSubFrameNum2 = NUM_OPEN_2_SENSOR_HLT;
            _gOpenSubFrameNum3 = NUM_OPEN_3_SENSOR_HLT;
            _gShortSubFrameNum1 = NUM_SHORT_1_SENSOR_HLT;
            _gShortSubFrameNum2 = NUM_SHORT_2_SENSOR_HLT;
            _gShortSubFrameNum3 = NUM_SHORT_3_SENSOR_HLT;

#ifdef CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE
            _gShort_RIU4 = short_4_HLT;
            _gShortSubFrameNum4 = NUM_SHORT_4_SENSOR_HLT;
#endif //CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE

            _gMAP1 = MAP1_HLT;
            _gMAP2 = MAP2_HLT;
            _gMAP3 = MAP3_HLT;
            _gMAP40_1 = MAP40_1_HLT;
            _gMAP40_2 = MAP40_2_HLT;
            _gMAP41_1 = MAP41_1_HLT;
            _gMAP41_2 = MAP41_2_HLT;

            _gSHORT_MAP1 = SHORT_MAP1_HLT;
            _gSHORT_MAP2 = SHORT_MAP2_HLT;
            _gSHORT_MAP3 = SHORT_MAP3_HLT;

#ifdef CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE       
            _gMAP40_3 = MAP40_3_HLT;
            _gMAP40_4 = MAP40_4_HLT;
            _gMAP41_3 = MAP41_3_HLT;
            _gMAP41_4 = MAP41_4_HLT;

            _gSHORT_MAP4 = SHORT_MAP4_HLT;
#endif //CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE
 
            _gItoTestKeyNum = NUM_KEY_HLT;
            _gItoTestDummyNum = NUM_DUMMY_HLT;
            _gItoTestTriangleNum = NUM_SENSOR_HLT;
            _gIsEnable2R = ENABLE_2R_HLT;
        }
    }
...
/*            _gOpen1 = MSG21XXA_open_1_Y;
        ...
        {
             _gOpenRIU1 = open_1_JD;
             _gOpenRIU2 = open_2_JD;
             _gOpenRIU3 = open_3_JD;

             _gShort_RIU1 = short_1_JD;
             _gShort_RIU2 = short_2_JD;
             _gShort_RIU3 = short_3_JD;

             _gOpenSubFrameNum1 = NUM_OPEN_1_SENSOR_JD;
             _gOpenSubFrameNum2 = NUM_OPEN_2_SENSOR_JD;
             _gOpenSubFrameNum3 = NUM_OPEN_3_SENSOR_JD;
             _gShortSubFrameNum1 = NUM_SHORT_1_SENSOR_JD;
             _gShortSubFrameNum2 = NUM_SHORT_2_SENSOR_JD;
             _gShortSubFrameNum3 = NUM_SHORT_3_SENSOR_JD;

#ifdef CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE       
             _gShort_RIU4 = short_4_JD;
             _gShortSubFrameNum4 = NUM_SHORT_4_SENSOR_JD;
#endif //CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE

             _gMAP1 = MAP1_JD;
             _gMAP2 = MAP2_JD;
             _gMAP3 = MAP3_JD;
             _gMAP40_1 = MAP40_1_JD;
             _gMAP40_2 = MAP40_2_JD;
             _gMAP41_1 = MAP41_1_JD;
             _gMAP41_2 = MAP41_2_JD;

             _gSHORT_MAP1 = SHORT_MAP1_JD;
             _gSHORT_MAP2 = SHORT_MAP2_JD;
             _gSHORT_MAP3 = SHORT_MAP3_JD;

#ifdef CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE       
             _gMAP40_3 = MAP40_3_JD;
             _gMAP40_4 = MAP40_4_JD;
             _gMAP41_3 = MAP41_3_JD;
             _gMAP41_4 = MAP41_4_JD;
        
             _gSHORT_MAP4 = SHORT_MAP4_JD;
#endif //CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE

             _gItoTestKeyNum = NUM_KEY_JD;
             _gItoTestDummyNum = NUM_DUMMY_JD;
             _gItoTestTriangleNum = NUM_SENSOR_JD;
             _gIsEnable2R = ENABLE_2R_JD;
        }
    }
    else
    {
