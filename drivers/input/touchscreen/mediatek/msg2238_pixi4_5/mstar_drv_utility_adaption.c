...
void DmaAlloc(void)
{
    if (NULL == I2CDMABuf_va)
    {
        ...
        I2CDMABuf_va = (u8 *)dma_alloc_coherent(&tpd->dev->dev, MAX_I2C_TRANSACTION_LENGTH_LIMIT, &I2CDMABuf_pa, GFP_KERNEL);
    }
...
void DmaFree(void)
{
    if (NULL != I2CDMABuf_va)
    {
	  //    dma_free_coherent(&tpd->dev, MAX_I2C_TRANSACTION_LENGTH_LIMIT, I2CDMABuf_va, I2CDMABuf_pa);
	     // I2CDMABuf_va = NULL;
	    //  I2CDMABuf_pa = 0;
/*dma_free_coherent(NULL, MAX_I2C_TRANSACTION_LENGTH_LIMIT, I2CDMABuf_va, I2CDMABuf_pa);
		I2CDMABuf_va = NULL;
		I2CDMABuf_pa = 0;*/
        DBG("DmaFree SUCCESS!\n");
    }
